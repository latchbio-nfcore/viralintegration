# nf-core/viralintegration: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/viralintegration/usage](https://nf-co.re/viralintegration/usage)
...
```bash
nextflow run nf-core/viralintegration -profile docker -params-file params.yaml
```
...
```bash
nextflow pull nf-core/viralintegration
```
